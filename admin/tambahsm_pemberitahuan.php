...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark"><i class="fas ffas fa-dice-d6 text-primary"></i> Tambah Surat pemberitahuan</h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
...
<section class="content">
  <div class="container-fluid">
    <?php if (isset($_SESSION['failed'])) {
      ...
      echo "<script>".$_SESSION['duplicate']."</script>";
      ...
      <div class="col-md-12">
        ...
        <div class="card card-primary border border-warning">
          <div class="card-header">
            <h3 class="card-title"><i class="fas ffas fa-dice-d6"></i> Isi data surat pemberitahuan</h3>
          </div>
          <!-- /.card-header -->
          <!-- form start -->
          <form role="form" method="POST" action="actions/tambahsm_pemberitahuan.php" enctype="multipart/form-data">
            <div class="card-body">
              <div class="row">
